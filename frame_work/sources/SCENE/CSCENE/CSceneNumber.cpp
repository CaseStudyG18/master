//=============================================================================
//
// CSceneNumberクラス [CSceneNumber.cpp]
// Author : 野尻　尚希
//
//=============================================================================
//*****************************************************************************
...
// デストラクタ
//*****************************************************************************
CSceneNumber ::~CSceneNumber(void)
{
}
...
// 初期化関数
//*****************************************************************************
void CSceneNumber :: Init(D3DXVECTOR3 pos, float width, float height, int number, TEXTURE_TYPE texType)
{
	VERTEX_2D *pVtx;
	...
	// ポリゴンのメモリ確保
	(*m_pD3DDevice)->CreateVertexBuffer(sizeof(VERTEX_2D) * 4			// 四角形なので4
	...
	pVtx[0].vtx = D3DXVECTOR3(m_vPos.x - m_fWidth * 0.5f
	...
	pVtx[1].tex = D3DXVECTOR2(MAX_UV_VALUE / (float)MAX_NUMBER_NUM, MIN_UV_VALUE);
	pVtx[2].tex = D3DXVECTOR2(MIN_UV_VALUE, MAX_UV_VALUE);
	pVtx[3].tex = D3DXVECTOR2(MAX_UV_VALUE / (float)MAX_NUMBER_NUM, MAX_UV_VALUE);
	//----------------------------------------------------------------------------------
...
// 数字セット関数
//*****************************************************************************
void CSceneNumber :: SetNumber(int number)
{
	float leftX, rightX;
...
{
	// 作成
	CSceneNumber* p = new CSceneNumber(pDevice);

	// 初期化
	p->Init(pos, width, height, number, texType);
...
// ポジションセット関数
//*****************************************************************************
void CSceneNumber::SetPos(D3DXVECTOR3 pos)
{
	m_vPos = pos;
