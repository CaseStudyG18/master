...
// コンストラクタ
//*****************************************************************************
CSceneMeshSky ::CSceneMeshSky(LPDIRECT3DDEVICE9 *pDevice, int nPriority):CScene(nPriority)
{
...
// クリエイト関数
//*****************************************************************************
CSceneMeshSky* CSceneMeshSky::Create(LPDIRECT3DDEVICE9 *pDevice, D3DXVECTOR3 pos, float r, float height, int wblock, int hblock, TEXTURE_TYPE texType, D3DXVECTOR3 rot)
{
	// 作成
