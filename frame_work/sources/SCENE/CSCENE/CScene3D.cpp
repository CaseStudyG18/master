...
// コンストラクタ
//*****************************************************************************
CScene3D ::CScene3D(LPDIRECT3DDEVICE9 *pDevice, int nPriority, OBJTYPE objType):CScene(nPriority, objType)
{
...
// 初期化関数
//*****************************************************************************
HRESULT CScene3D :: Init(D3DXVECTOR3 pos, float width, float height, TEXTURE_TYPE texType, int wblock, int hblock)
{
	VERTEX_3D *pVtx;
	...
	// ポリゴンのメモリ確保
	if(FAILED((*m_pD3DDevice)->CreateVertexBuffer(sizeof(VERTEX_3D) * 4			// 四角形の頂点数なので * 4
